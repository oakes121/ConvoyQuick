    ...
    private void setFlag(int counter) {
        ...
        if (trueCount < 2) {            
            if (vehiclePanelClickedFlags.get(counter).getTruthValue() == false) {
                ...
                trueCount++;
                swapPanel();
                //JOptionPane.showMessageDialog(this, "one "+ trueCount, "count", JOptionPane.WARNING_MESSAGE);
            }
            else if (vehiclePanelClickedFlags.get(counter).getTruthValue() == true) {
                vehiclePanelClickedFlags.get(counter).setTruthValue(false);
                --trueCount;
                pos1 = pos2 = -1;
                //JOptionPane.showMessageDialog(this, "two "+ trueCount, "count", JOptionPane.WARNING_MESSAGE);
                addBorder(counter, 0);
            }
        }  else if (trueCount >= 2) {
            if (vehiclePanelClickedFlags.get(counter).getTruthValue() == true) {
                ...
                --trueCount;
                pos1 = pos2 = -1;
                //JOptionPane.showMessageDialog(this, "three "+ trueCount, "count", JOptionPane.WARNING_MESSAGE);
                addBorder(counter, 0);
            }            
        }       
    }
